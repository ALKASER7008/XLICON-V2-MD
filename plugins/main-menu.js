import {
  ...
  *%ucpn*
⍟────────────────⍟
*تذكر ان هذا البوت مخصص للأغراض التعليمية☺️*
⍟────────────────⍟
*𝑨𝑳𝑲𝑨𝑺𝑬𝑹*
⍟────────────────⍟
*_تم التعديل بواسطه ALKASER_*
⍟────────────────⍟
...
┃ *_حاله البوت_*: %mode
┃ *_يستضيف_*: kali Linix
┃ *_لغه البرمجه_*: NodeJs
┃ *_الاسوار_*: _جهاز متعدد_
┃ *_البادئه للاوامر_*: [ *%_p* ]
┃ *_وقت التشغيل_*: %muptime
┃ *_قاعد البيانات_*:  %totalreg
┃
╰──────────────────⦿
╭──────────────────⦿
┃    🔰〘 يوزرك 〙🔰
...
┃ *_اسمك_*: %name
┃ *_ذهبك_*: %credit
┃ *_دور_*: ALKASER-BOT-TESTER
┃ *_مستوى_*: %level [ %xp4levelup Xp For Levelup]
┃ *_نقاطك_*: %exp / %maxexp
┃ *_مجموع نقاطك_*: %totalexp
┃
╰──────────────────⦿
╭──────────────────⦿
┃   🔰〘 معلومات cmd 〙🔰
